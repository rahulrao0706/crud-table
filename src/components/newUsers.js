    ...
    return (<>
        <div className="mb-3">
            <form onSubmit={handleSubmit}>
                ...
                <input type="email" className = "form-control" id = "exampleInputEmail1" placeholder = "email" aria-describedby="emailHelp" value={email} onChange={(e) => setEmail(e.target.value)}></input>
                ...
                <select className = "form-select" aria-label = "Default select example" value =
